    ...
    return (
        <div className="space-y-3">
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                <div>
                    <h2 className="text-2xl font-bold text-[#018f8f] tracking-tight">Utilisateurs & Équipe</h2>
                                    ...
                                    <td className="p-4 text-right">
                                        <div className="flex justify-end gap-2">
                                            <button 
                                                ...
                                                className="p-2 text-gray-400 hover:text-[#018f8f] hover:bg-teal-50 rounded-sm transition-colors"
                                            >
                    ...
                    <div className="bg-white rounded-sm shadow-2xl w-full max-w-md overflow-hidden animate-in fade-in zoom-in-95 duration-200">
                        <div className="p-5 border-b border-gray-100 flex justify-between items-center bg-gray-50">
                            <h2 className="text-xl font-bold text-gray-800 flex items-center gap-2">
                                <Users className="w-5 h-5 text-[#018f8f]" />
                        ...
                        <form onSubmit={handleSave} className="p-6 space-y-4">
                            <div>
                                ...
                                <input 
                                    ...
                                    className="w-full p-2.5 bg-white border border-gray-200 rounded-sm focus:ring-2 focus:ring-[#018f8f] outline-none transition-all"
                            ...
                            <div className="flex gap-3 pt-4 border-t border-gray-100">
                                ...
                                <button 
                                    type="submit"
                                    className="flex-1 px-4 py-2 text-white bg-[#018f8f] rounded-sm hover:bg-teal-700 font-medium transition-colors flex items-center justify-center gap-2"
                                >
